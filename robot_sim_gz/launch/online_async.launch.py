...
def generate_launch_description():
    ...
    default_params_file = os.path.join(get_package_share_directory("robot_sim_gz"),
    ...
    has_node_params = HasNodeParams(source_file=default_params_file,
    ...
    start_async_slam_toolbox_node = Node(
        ...
        remappings=[('/map','map'),('/map_metadata','map_metadata'),
                    ('/tf','tf'),('/tf_static','tf_static'),('/scan','scan')]
        )
