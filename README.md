...
cd ~/ros2_ws/src
git clone https://github.com/Aymen-Jocef/multi-agent-system-AC-SLAM
...
# Visualization (RViz2)
After launching the robots and their respective SLAM and navigation nodes run **rviz2** and add the map topics to visualize the map of each robot. 

# Map Merging (Multi-Robot Mapping)
To merge the maps generated by each robot into a single global occupancy grid, use the external package:
https://github.com/abdulkadrtr/mapMergeForMultiRobotMapping-ROS2
